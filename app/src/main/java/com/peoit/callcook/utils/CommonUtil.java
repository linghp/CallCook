package com.peoit.callcook.utils;
...
import com.peoit.callcook.MyApplication;
...
//				R.anim.slide_left_out);
	...
	public static int getVersionCode() {
		PackageManager manager = MyApplication.mInstance.getPackageManager();
		try {
			PackageInfo info = manager.getPackageInfo(
					MyApplication.mInstance.getPackageName(), 0);
